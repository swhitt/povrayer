...
export const FEATURED_EXAMPLE_NAMES = [
  ...
  'sourced-blob-cluster',
  'julia-fractal',
  'helix',
  'materials',
  'normal-study',
  'sourced-biscuit',
  'sourced-marble-pattern',
  'glass',
  'sourced-wineglass',
  'sourced-magglass',
  'sourced-diffract',
...
const EXAMPLE_META = {
  ...
  'sourced-orthographic-camera': { difficulty: 'intro', renderTier: 'instant' },
  'sourced-omnimax-camera': { difficulty: 'intermediate', renderTier: 'fast' },
  'sourced-spherical-camera': { difficulty: 'intermediate', renderTier: 'fast' },
  'sourced-ultra-wide-camera': { difficulty: 'intermediate', renderTier: 'fast' },
  'sourced-circular-area-light': { difficulty: 'intro', renderTier: 'fast' },
  'sourced-spotlight': { difficulty: 'intro', renderTier: 'instant' },
  'sourced-parallel-light': { difficulty: 'intermediate', renderTier: 'instant' },
  'sourced-projected-through': { difficulty: 'intermediate', renderTier: 'fast' },
  'sourced-blob-cluster': { difficulty: 'intro', renderTier: 'fast' },
  'sourced-fractal-julia': { difficulty: 'advanced', renderTier: 'heavy' },
  'sourced-isosurface-gallery': { difficulty: 'advanced', renderTier: 'heavy' },
  'sourced-lathe-gallery': { difficulty: 'intro', renderTier: 'instant' },
  'sourced-mesh2-cushion': { difficulty: 'intermediate', renderTier: 'instant' },
  'sourced-prism-sweep': { difficulty: 'intro', renderTier: 'fast' },
  'sourced-sor-gallery': { difficulty: 'intermediate', renderTier: 'instant' },
  'sourced-superellipsoid-cubes': { difficulty: 'intermediate', renderTier: 'fast' },
  'sourced-torus-gallery': { difficulty: 'intro', renderTier: 'instant' },
  'sourced-lemniscate': { difficulty: 'advanced', renderTier: 'fast' },
  'sourced-monkey-saddle': { difficulty: 'advanced', renderTier: 'heavy' },
  'sourced-steiner-surface': { difficulty: 'advanced', renderTier: 'heavy' },
  'sourced-witch-surface': { difficulty: 'advanced', renderTier: 'fast' },
  'sourced-agate-pattern': { difficulty: 'intro', renderTier: 'instant' },
  'sourced-marble-pattern': { difficulty: 'intro', renderTier: 'instant' },
  'sourced-spiral-pattern': { difficulty: 'intro', renderTier: 'instant' },
  'sourced-crackle-cells': { difficulty: 'intro', renderTier: 'instant' },
  'sourced-pavement-tiles': { difficulty: 'intermediate', renderTier: 'instant' },
  'sourced-object-pattern': { difficulty: 'advanced', renderTier: 'fast' },
  'sourced-whiltile': { difficulty: 'intermediate', renderTier: 'fast' },
  'sourced-float-math': { difficulty: 'intermediate', renderTier: 'instant' },
