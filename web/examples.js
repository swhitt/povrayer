...
// sourceUrl, license (SPDX), animated, frames, fps, and source. All 29 shipped
// scenes are original work: author 'povrayer', license 'CC0-1.0', sourceUrl ''.
//
// Order here is the manifest order: the 11 originals first (csg-die leads as the
// default first impression), then the 18 authored additions. The browser groups
// and orders scenes via CATEGORIES, never by this array's iteration order.
